  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'cloakroom',
    {
      ...
      elements = {
        ...
        {label = _U('triades_wear'), value = 'triades_wear'},
      },
    },
    function(data, menu)
      ...
      if data.current.value == 'triades_wear' then
      ...
      CurrentAction     = 'triades_actions_menu'
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.triadesStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.triadesStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_triadesjob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function OpentriadesActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'triades_actions',
    {
      title    = 'triades.png',
      align    = 'top-left',
      elements = elements
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_triadesjob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_triadesjob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_triadesjob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_triadesjob:OutVehicle', GetPlayerServerId(player))
              end
...
RegisterNetEvent('esx_triadesjob:objectspawner_cl')
AddEventHandler('esx_triadesjob:objectspawner_cl', function(model, x, y, z, h)
  ESX.Game.SpawnObject(model, {
    x = x,
    y = y,
    z = z
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_triadesjob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil and data.current.value ~= 'black_money' then
          ...
          TriggerServerEvent('esx_triadesjob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_triades', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getVehicleInfos', function(infos)
...
function OpenVehicleInfosServiceMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getVehicleInfosService', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_triadesjob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_triadesjob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_triadesjob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_triadesjob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_triadesjob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_triadesjob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_triadesjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.triadesStations[station].Helicopters
...
AddEventHandler('esx_triadesjob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_triadesjob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'triades' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_triadesjob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_triadesjob:handcuff')
AddEventHandler('esx_triadesjob:handcuff', function()
...
RegisterNetEvent('esx_triadesjob:drag')
AddEventHandler('esx_triadesjob:drag', function(cop)
...
RegisterNetEvent('esx_triadesjob:putInVehicle')
AddEventHandler('esx_triadesjob:putInVehicle', function()
...
RegisterNetEvent('esx_triadesjob:OutVehicle')
AddEventHandler('esx_triadesjob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'triades' then
      ...
      for k,v in pairs(Config.triadesStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'triades' and PlayerData.job.grade_name == 'boss' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_triadesjob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_triadesjob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_triadesjob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_triadesjob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
----TriggerEvent('es:RegisterCommand', 'shield', 'triades', function(source, args, user)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'triades' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'triades', vehicleProps)

          else

            if
              GetEntityModel(vehicle) == GetHashKey('triades')  or
              GetEntityModel(vehicle) == GetHashKey('triades2') or
              GetEntityModel(vehicle) == GetHashKey('triades3') or
              GetEntityModel(vehicle) == GetHashKey('triadesb') or
              GetEntityModel(vehicle) == GetHashKey('pbus') or
              GetEntityModel(vehicle) == GetHashKey('riot') or
			  GetEntityModel(vehicle) == GetHashKey('triadest')
            then
              TriggerServerEvent('esx_service:disableService', 'triades')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'triades', function(data, menu)
    ...
    if IsControlPressed(0,  Keys['G']) and GetLastInputMethod( 0 ) and PlayerData.job ~= nil and PlayerData.job.name == 'triades' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'triades_actions') and (GetGameTimer() - GUI.Time) > 150 then
      OpentriadesActionsMenu()
      GUI.Time = GetGameTimer()
    end
