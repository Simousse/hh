...
function OpenCloakroomMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      CurrentAction     = 'aztecas_actions_menu'
...
RegisterNetEvent('esx_aztecasjob:objectspawner_cl')
AddEventHandler('esx_aztecasjob:objectspawner_cl', function(model, x, y, z, h)
  ESX.Game.SpawnObject(model, {
    x = x,
    y = y,
    z = z
...
function OpenVehicleInfosServiceMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_aztecasjob:getVehicleInfosService', function(infos)
...
AddEventHandler('esx_aztecasjob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.aztecasStations[station].Helicopters
...
AddEventHandler('esx_aztecasjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'aztecas' and not IsPedInAnyVehicle(playerPed, false) then
...
----TriggerEvent('es:RegisterCommand', 'shield', 'aztecas', function(source, args, user)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'aztecas' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              GetEntityModel(vehicle) == GetHashKey('aztecas')  or
              GetEntityModel(vehicle) == GetHashKey('aztecas2') or
              GetEntityModel(vehicle) == GetHashKey('aztecas3') or
              GetEntityModel(vehicle) == GetHashKey('aztecasb') or
              GetEntityModel(vehicle) == GetHashKey('pbus') or
              GetEntityModel(vehicle) == GetHashKey('riot') or
			  GetEntityModel(vehicle) == GetHashKey('aztecast')
            then
    ...
    if IsControlPressed(0,  Keys['G']) and GetLastInputMethod( 0 ) and PlayerData.job ~= nil and PlayerData.job.name == 'aztecas' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'aztecas_actions') and (GetGameTimer() - GUI.Time) > 150 then
