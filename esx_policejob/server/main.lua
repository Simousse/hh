...
RegisterServerEvent('esx_policejob:buyGunLicense')
AddEventHandler('esx_policejob:buyGunLicense', function (xPlayerId)
  local xPlayers    = ESX.GetPlayers()
  for i=1, #xPlayers, 1 do
    local xPlayer = ESX.GetPlayerFromId(xPlayers[i])
    if xPlayer.source == xPlayerId then
      xPlayerSource = xPlayer
      break
    end
  end
  if xPlayerSource ~= nil then
    TriggerEvent('esx_license:addLicense', xPlayerSource.source, 'weapon', function ()
      TriggerEvent('esx_license:getLicenses', xPlayerSource.source, function (licenses)
        TriggerClientEvent('esx_weashop:loadLicenses', xPlayerSource.source, licenses)
      end)
    end)
    TriggerClientEvent('esx:showNotification', source, _U('you_attributed_gun_licenses', xPlayerSource.name))
    TriggerClientEvent('esx:showNotification', xPlayerSource.source, _U('you_have_gun_licenses'))
  end
end)
...
ESX.RegisterServerCallback('esx_policejob:getVehicleInfosService', function(source, cb, plate)
