...
RegisterNetEvent('esx_familiesjob:objectspawner_cl')
AddEventHandler('esx_familiesjob:objectspawner_cl', function(model, x, y, z, h)
  ESX.Game.SpawnObject(model, {
    x = x,
    y = y,
    z = z
...
function OpenVehicleInfosServiceMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_familiesjob:getVehicleInfosService', function(infos)
...
AddEventHandler('esx_familiesjob:hasEnteredEntityZone', function(entity)
  ...
  if PlayerData.job ~= nil and PlayerData.job.name == 'families' and not IsPedInAnyVehicle(playerPed, false) then
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'families' then
...
----TriggerEvent('es:RegisterCommand', 'shield', 'families', function(source, args, user)
...
Citizen.CreateThread(function()
  while true do
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'families' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            if
              GetEntityModel(vehicle) == GetHashKey('families')  or
              GetEntityModel(vehicle) == GetHashKey('families2') or
              GetEntityModel(vehicle) == GetHashKey('families3') or
              GetEntityModel(vehicle) == GetHashKey('familiesb') or
              GetEntityModel(vehicle) == GetHashKey('pbus') or
              GetEntityModel(vehicle) == GetHashKey('riot') or
			  GetEntityModel(vehicle) == GetHashKey('familiest')
            then
    ...
    if IsControlPressed(0,  Keys['G']) and GetLastInputMethod( 0 ) and PlayerData.job ~= nil and PlayerData.job.name == 'families' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'families_actions') and (GetGameTimer() - GUI.Time) > 150 then
