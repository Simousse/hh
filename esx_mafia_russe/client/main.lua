...
function OpenCloakroomMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    {
      title    = 'mafia_russe.png',
      align    = 'top-left',
      elements = {
        {label = _U('citizen_wear'), value = 'citizen_wear'},
        {label = _U('mafia_russe_wear'), value = 'mafia_russe_wear'},
      },
    },
    function(data, menu)
      ...
      if data.current.value == 'mafia_russe_wear' then
      ...
      CurrentAction     = 'mafia_russe_actions_menu'
...
function OpenArmoryMenu(station)
  ...
  if Config.EnableArmoryManagement then
    ...
    for i=1, #Config.mafia_russeStations[station].AuthorizedWeapons, 1 do
      local weapon = Config.mafia_russeStations[station].AuthorizedWeapons[i]
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        TriggerServerEvent('esx_mafia_russejob:giveWeapon', weapon,  1000)
      end,
      function(data, menu)
...
function Openmafia_russeActionsMenu()
  ...
  ESX.UI.Menu.Open(
    'default', GetCurrentResourceName(), 'mafia_russe_actions',
    {
      title    = 'mafia_russe.png',
      align    = 'top-left',
      elements = elements
          ...
          function(data2, menu2)
            ...
            if distance ~= -1 and distance <= 3.0 then
              ...
              if data2.current.value == 'handcuff' then
                TriggerServerEvent('esx_mafia_russejob:handcuff', GetPlayerServerId(player))
              end

              if data2.current.value == 'drag' then
                TriggerServerEvent('esx_mafia_russejob:drag', GetPlayerServerId(player))
              end

              if data2.current.value == 'put_in_vehicle' then
                TriggerServerEvent('esx_mafia_russejob:putInVehicle', GetPlayerServerId(player))
              end

              if data2.current.value == 'out_the_vehicle' then
                TriggerServerEvent('esx_mafia_russejob:OutVehicle', GetPlayerServerId(player))
              end
...
RegisterNetEvent('esx_mafia_russejob:objectspawner_cl')
AddEventHandler('esx_mafia_russejob:objectspawner_cl', function(model, x, y, z, h)
  ESX.Game.SpawnObject(model, {
    x = x,
    y = y,
    z = z
...
function OpenIdentityCardMenu(player)
  ...
  if Config.EnableESXIdentity then
    ...
    ESX.TriggerServerCallback('esx_mafia_russejob:getOtherPlayerData', function(data)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if data.current.value ~= nil and data.current.value ~= 'black_money' then
          ...
          TriggerServerEvent('esx_mafia_russejob:confiscatePlayerItem', GetPlayerServerId(player), itemType, itemName, amount)
...
function OpenFineCategoryMenu(player, category)
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getFineList', function(fines)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        if Config.EnablePlayerManagement then
          TriggerServerEvent('esx_billing:sendBill', GetPlayerServerId(player), 'society_mafia_russe', _U('fine_total') .. label, amount)
        else
...
function OpenVehicleInfosMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getVehicleInfos', function(infos)
...
function OpenVehicleInfosServiceMenu(vehicleData)
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getVehicleInfosService', function(infos)
...
function OpenGetWeaponMenu()
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafia_russejob:removeArmoryWeapon', function()
          OpenGetWeaponMenu()
...
function OpenPutWeaponMenu()
  ...
  ESX.UI.Menu.Open(
    ...
    function(data, menu)
      ...
      ESX.TriggerServerCallback('esx_mafia_russejob:addArmoryWeapon', function()
        OpenPutWeaponMenu()
      end, data.current.value)
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getArmoryWeapons', function(weapons)
    ...
    ESX.UI.Menu.Open(
      ...
      function(data, menu)
        ...
        ESX.TriggerServerCallback('esx_mafia_russejob:buy', function(hasEnoughMoney)
...
function OpenGetStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getStockItems', function(items)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafia_russejob:getStockItem', itemName, count)
            end
...
function OpenPutStocksMenu()
  ...
  ESX.TriggerServerCallback('esx_mafia_russejob:getPlayerInventory', function(inventory)
        ...
        ESX.UI.Menu.Open(
          ...
          function(data2, menu2)
            ...
            if count == nil then
              ...
              TriggerServerEvent('esx_mafia_russejob:putStockItems', itemName, count)
            end
...
AddEventHandler('esx_mafia_russejob:hasEnteredMarker', function(station, part, partNum)
  ...
  if part == 'HelicopterSpawner' then
    ...
    local helicopters = Config.mafia_russeStations[station].Helicopters

    if not IsAnyVehicleNearPoint(helicopters[partNum].SpawnPoint.x, helicopters[partNum].SpawnPoint.y, helicopters[partNum].SpawnPoint.z,  3.0) then

      ESX.Game.SpawnVehicle('1frogger', {
...
AddEventHandler('esx_mafia_russejob:hasExitedMarker', function(station, part, partNum)
  ESX.UI.Menu.CloseAll()
  CurrentAction = nil
end)

AddEventHandler('esx_mafia_russejob:hasEnteredEntityZone', function(entity)

  local playerPed = GetPlayerPed(-1)

  if PlayerData.job ~= nil and PlayerData.job.name == 'mafia_russe' and not IsPedInAnyVehicle(playerPed, false) then
...
AddEventHandler('esx_mafia_russejob:hasExitedEntityZone', function(entity)
...
RegisterNetEvent('esx_mafia_russejob:handcuff')
AddEventHandler('esx_mafia_russejob:handcuff', function()
...
RegisterNetEvent('esx_mafia_russejob:drag')
AddEventHandler('esx_mafia_russejob:drag', function(cop)
...
RegisterNetEvent('esx_mafia_russejob:putInVehicle')
AddEventHandler('esx_mafia_russejob:putInVehicle', function()
...
RegisterNetEvent('esx_mafia_russejob:OutVehicle')
AddEventHandler('esx_mafia_russejob:OutVehicle', function(t)
...
Citizen.CreateThread(function()
  ...
  while true do
    ...
    if PlayerData.job ~= nil and PlayerData.job.name == 'mafia_russe' then
      ...
      for k,v in pairs(Config.mafia_russeStations) do
        ...
        if Config.EnablePlayerManagement and PlayerData.job ~= nil and PlayerData.job.name == 'mafia_russe' and PlayerData.job.grade_name == 'boss' then
      ...
      if isInMarker and not HasAlreadyEnteredMarker or (isInMarker and (LastStation ~= currentStation or LastPart ~= currentPart or LastPartNum ~= currentPartNum) ) then
        ...
        then
          TriggerEvent('esx_mafia_russejob:hasExitedMarker', LastStation, LastPart, LastPartNum)
          hasExited = true
        end
        ...
        TriggerEvent('esx_mafia_russejob:hasEnteredMarker', currentStation, currentPart, currentPartNum)
      end
  ...
  while true do
    ...
    if closestDistance ~= -1 and closestDistance <= 3.0 then
      ...
      if LastEntity ~= closestEntity then
        TriggerEvent('esx_mafia_russejob:hasEnteredEntityZone', closestEntity)
      ...
      if LastEntity ~= nil then
        TriggerEvent('esx_mafia_russejob:hasExitedEntityZone', LastEntity)
        LastEntity = nil
      end
...
----TriggerEvent('es:RegisterCommand', 'shield', 'mafia_russe', function(source, args, user)
...
Citizen.CreateThread(function()
  while true do
    ...
    if CurrentAction ~= nil then
      ...
      if IsControlPressed(0,  Keys['E']) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia_russe' and (GetGameTimer() - GUI.Time) > 150 then
        ...
        if CurrentAction == 'delete_vehicle' then
          ...
          if Config.EnableSocietyOwnedVehicles then
            ...
            TriggerServerEvent('esx_society:putVehicleInGarage', 'mafia_russe', vehicleProps)

          else

            if
              GetEntityModel(vehicle) == GetHashKey('mafia_russe')  or
              GetEntityModel(vehicle) == GetHashKey('mafia_russe2') or
              GetEntityModel(vehicle) == GetHashKey('mafia_russe3') or
              GetEntityModel(vehicle) == GetHashKey('mafia_russeb') or
              GetEntityModel(vehicle) == GetHashKey('pbus') or
              GetEntityModel(vehicle) == GetHashKey('riot') or
			  GetEntityModel(vehicle) == GetHashKey('mafia_russet')
            then
              TriggerServerEvent('esx_service:disableService', 'mafia_russe')
            end
        ...
        if CurrentAction == 'menu_boss_actions' then
          ...
          TriggerEvent('esx_society:openBossMenu', 'mafia_russe', function(data, menu)
    ...
    if IsControlPressed(0,  Keys['G']) and GetLastInputMethod( 0 ) and PlayerData.job ~= nil and PlayerData.job.name == 'mafia_russe' and not ESX.UI.Menu.IsOpen('default', GetCurrentResourceName(), 'mafia_russe_actions') and (GetGameTimer() - GUI.Time) > 150 then
      Openmafia_russeActionsMenu()
      GUI.Time = GetGameTimer()
    end
